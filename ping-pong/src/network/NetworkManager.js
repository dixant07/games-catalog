...
export class NetworkManager {
    ...
    initializeWebSocketNetworking() {
        ...
        // Forward raw game data (one-way) into the scene emitter so
        // PingPongConnection can decode it. Guard to avoid re-entry.
    ...
    async connectToGame() {
        ...
        if (this.localNetworkManager) {
            ...
            // Expose the underlying game connection so GameScene can create
            // PingPongConnection and forward game data.
